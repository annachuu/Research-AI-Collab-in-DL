...
AISerendipitySchema.virtual('@id').get(function() {
    return this.externalId;
});

AISerendipitySchema.set('toJSON', { virtuals: true });
AISerendipitySchema.set('toObject', { virtuals: true });

module.exports = mongoose.model('AISerendipity', AISerendipitySchema);
